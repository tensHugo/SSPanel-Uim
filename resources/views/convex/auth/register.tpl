...
<html>
    ...
    <body data-col="1-column" class=" 1-column  blank-page blank-page">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 controls">
                                                    <input type="text" class="form-control form-control-lg" name="name"
                                                        id="name" placeholder="昵称" required
                                                        data-validation-required-message="用户名必须填">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12 controls">
                                                    <input type="email" class="form-control form-control-lg"
                                                        ...
                                                        autocomplete="username" placeholder="邮箱(唯一凭证请认真对待)" required
                                                        data-validation-required-message="邮箱必须填写">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="dropdown" placement="top-right">
                                                            <div class="input-group-prepend">
                                                                <button
                                                                    class="btn btn-info dropdown-toggle form-control-lg"
                                                                    data-toggle="dropdown" id="im_type" name="im_type"
                                                                    value="1">请选择</button>
                                                                <div class="dropdown-menu" id="im_type"
                                                                    aria-labelledby="dropdownBasic12">
                                                                    <button type="button"
                                                                        class="im-type-btn dropdown-item"
                                                                        onclick="setImType(2)">QQ</button>
                                                                    <button type="button"
                                                                        class="im-type-btn dropdown-item"
                                                                        onclick="setImType(1)">微信</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="text" id="im_value" name="im_value"
                                                            placeholder="请输入社交账号" class="form-control form-control-lg"
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 controls">
                                                    <input type="password" class="form-control form-control-lg"
                                                        name="passwd" id="passwd" placeholder="密码" required
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 controls">
                                                    <input type="text" class="form-control form-control-lg" name="code"
                                                        ...
                                                        placeholder="邀请码（必填）" required
                                                        data-validation-required-message="请填写邀请码">
                                                </div>
                                            </div>
                                            {/if}
                                            <div class="form-group col-sm-offset-1">
                                                <div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                                    <input type="checkbox" value="1" class="custom-control-input" checked required
                                                        id="terms">
                                                    <label class="custom-control-label pl-2" for="terms">阅读并接受<a target="_blank" href="/useragr">《用户协议》</a>和 <a target="_blank" href="/privacy">《隐私政策》</a></label>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <button type="button" data-toggle="modal" data-target="#large" id="reg"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel17">国际网络加速服务信息安全承诺书</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            {include file='commitment.tpl'}
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn grey btn-outline-secondary"
                                data-dismiss="modal">我不承诺</button>
                            <button type="button" class="btn btn-outline-primary" id="register">我承诺</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="/theme/convex/app-assets/js/components-modal.min.js"></script>
        <script>
            $("input,select,textarea").not("[type=submit]").jqBootstrapValidation();

            var isTongyi = $('#terms:checked').val();
                       ...
                       $.ajax({
                           ...
                           data: {
                            ...
                            {/if}
                               ...
                               success: (data) => {
                                   if (data.ret == 1) {
                                       swal("注册成功", data.msg, "success").then(
                                           function() {
                                               window.setTimeout(
                                                   "location.href='/user'", {$config['jump_delay']});
                                           }).done();
                                   } else {
